...
export const Header: React.FC<HeaderProps> = ({onMenuClick}) => {
    ...
    return (
        <>
            <header
                className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 py-2.5 px-4 w-full">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <div className="hidden sm:block border-l border-gray-200 dark:border-gray-700 pl-2.5">
                                <p className="text-sm font-bold text-gray-900 dark:text-gray-100 leading-tight">GSD
                                    Associates</p>
                                <p className="text-[11px] text-gray-400 dark:text-gray-500 leading-tight">Georgia
                                    Urology</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2.5">
                        <img
                            src="https://i.imgur.com/vReG3a4.jpeg"
                            alt="Bot Avatar"
                            className="flex-shrink-0 w-8 h-8 rounded-md object-cover shadow-sm"
                        />
                        <div>
            ...
            {isSettingsOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    {/* Modal panel */}
                    <div
                        className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 p-4 space-y-4 w-full max-w-sm">
                        ...
                        <div className="space-y-1.5">
                            <label
                                className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Welcome
                                Message</label>
                            <input
                                type="text"
                        ...
                        <div className="flex items-center justify-between py-1">
                            <label
                                className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Dark
                                Mode</label>
                            <button
                                role="switch"
                            ...
                            >
                                <span
                                    className={`inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform ${config.darkMode ? 'translate-x-4' : 'translate-x-0.5'}`}/>
                            </button>
                        </div>
